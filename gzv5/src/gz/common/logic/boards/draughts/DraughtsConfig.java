...
public class DraughtsConfig {
	...
	//                                                                    mcksk = has maximum capture priority capturing maximum amount of kings starting capturing a king
	//                                                                    mbkc = man can become king during capture
	//                                                                    ac = man can avoid back captures
	//                                                                    sb = has system blocks
	//                                                                    md = number of moves without capturing or promoting to draw
	//
	//                                             		                  (s,    c,     m,     ck,    bk,    nsbk,  sclw,  fk,    mc,    mcwk,  mck,   mcksk, mbkc,  ac,    sb,    md)
	public static final DraughtsConfig BRAZILIAN = 		new DraughtsConfig(8,    WHITE, false, true,  true,  false, false, true,  true,  false, false, false, false, false, false, 40); // brazilian
	public static final DraughtsConfig SPANISH = 		new DraughtsConfig(8,    WHITE, false, true,  false, false, true,  true,  true,  false, true,  false, false, false, false, 40); // spanish
	public static final DraughtsConfig ITALIAN = 		new DraughtsConfig(8,    WHITE, false, false, false, false, true,  false, true,  true,  true,  true,  false, false, false, 50); // italian
	public static final DraughtsConfig RUSSIAN = 		new DraughtsConfig(8,    WHITE, false, true,  true,  false, false, true,  false, false, false, false, true,  false, false, 40); // russian
 	public static final DraughtsConfig INTERNATIONAL = 	new DraughtsConfig(10,   WHITE, false, true,  true,  false, false, true,  true,  false, false, false, false, false, false, 50); // international
	public static final DraughtsConfig AMERICAN = 		new DraughtsConfig(8,    WHITE, false, true,  false, false, true,  false, false, false, false, false, false, false, false, 50); // american
	public static final DraughtsConfig AMERICAN10x10 = 	new DraughtsConfig(10,   WHITE, false, true,  false, false, true,  false, false, false, false, false, false, false, false, 50); // american 10x10
	public static final DraughtsConfig GAMEZERV5 = 		new DraughtsConfig(8,    WHITE, false, true,  false, true,  true,  false, false, false, false, false, false, true,  true,  50); // gamezer v5
	...
	private boolean canManAvoidBackCaptures;
	private boolean hasSystemBlocks;
	...
	public DraughtsConfig(
			...
			int initialColor, 
			boolean isMirrored, 
			boolean canManCaptureKings, 
			boolean canManMakeBackCaptures, 
			boolean manDontStartBackCaptures, 
			boolean stopCapturingAtLastRow, 
			boolean hasFlyingKings,
			boolean hasMaximumCapture, 
			boolean hasMaximumCaptureWithKings, 
			boolean hasMaximumCaptureAmountOfKings,
			boolean hasMaximumCaptureAmountOfKingsStartingCapturingAKing,
			boolean manCanBecomeKingDuringCapture, 
			boolean canManAvoidBackCaptures, 
			boolean hasSystemBlocks, 
			int minimalNumberNumberMovesToDraw
			) {
		this.size = size;
		...
		this.canManAvoidBackCaptures = canManAvoidBackCaptures;
		this.hasSystemBlocks = hasSystemBlocks;
		this.minimalNumberNumberMovesToDraw = minimalNumberNumberMovesToDraw;
	}

	public boolean canManAvoidBackCaptures() {
		return canManAvoidBackCaptures;
	}
	...
	public void setHasQualityCapture(boolean hasQualityCapture) {
		this.hasMaximumCaptureAmountOfKings = hasQualityCapture;
	}
