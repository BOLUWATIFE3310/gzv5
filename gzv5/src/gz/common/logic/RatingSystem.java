...
public class RatingSystem<T> {
	...
	public static final float DEFAULT_MIN_GAIN = 0;
	public static final float DEFAULT_MAX_GAIN = 50;
	public static final float DEFAULT_MIN_LOSS = 0;
	...
	public static void main(String... args) {
		...
		system.setMinRating(0);
		system.setMaxRating(100000000);
		system.cleanup();
		system.addRating(2000);
		system.addRating(100);
		system.setWinner(0);
		system.compute();
