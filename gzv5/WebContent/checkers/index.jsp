...
<%
Container servlet = (Container) application.getAttribute("checkers");
if (servlet == null)
	return;
...
<html>
	<head>
		...
		function init_m(){
			...
			var STV = '<%= STV %>';
			smj.innerHTML = 
						'<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,115,0" width="1000" height="500" id="flashindex" align="middle" >' +
							'<param name="allowScriptAccess" value="always" />' +
							'<param name="allowNetworking" value="all" />' +
							'<param name="menu" value="false" />' +
							'<param name="wmode" value="gpu" />' +
							'<param name="flashvars" value="'+vp+'" />' +
							'<param name="movie" value="<%= homeurl %>/swf_v5/base/flashindex_'+STV+'.swf" />' +
							'<param name="quality" value="high" />' +
							'<param name="bgcolor" value="#000000" />' +
							'<embed src="<%= homeurl %>/swf_v5/base/flashindex_'+STV+'.swf" flashvars="'+vp+'" menu="false" wmode="gpu" quality="high" bgcolor="#000000" width="1000" height="500" name="flashindex" align="middle" allowScriptAccess="always" allowNetworking="all" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />' +
						'</object>';
		...
		<script>
			...
			function defineSlots() {
				...
				googletag.cmd.push(function() {
					...
					googletag.defineSlot('/137571108/gamez_checkers_header', [728, 90], 'div-gpt-ad-1477637113781-0').addService(googletag.pubads());
			
					googletag.defineSlot('/137571108/gamez_checkers_left', [160, 600], 'div-gpt-ad-1477637175508-0').addService(googletag.pubads());
			
					googletag.defineSlot('/137571108/gamez_checkers_right', [160, 600], 'div-gpt-ad-1477637221269-0').addService(googletag.pubads());
			...
			<table cellpadding="0" cellspacing="0" align="center" width="100%"
				...
				<tr align="center" valign="middle" colspan="20" width="100%">
						...
						<table cellpadding="0" cellspacing="0" align="center" width="1000" height="100%" border="0">
							...
							<tr align="center" valign="top" colspan="15" width="100%">
								<td valign="middle" align="center" colspan="15" width="100%" >
									<% if (!domainhost.equals("localhost")) { %>
									<% if (useDFP) { %>
									<!-- /137571108/gamez_checkers_header -->
					...
					<td valign="middle" align="right" colspan="5" >
						<% if (!domainhost.equals("localhost")) { %>
						<% if (useDFP) { %>
						<!-- /137571108/gamez_checkers_right -->
						...
						<table cellpadding="0" cellspacing="0" align="center" border="0">
							<tr valign="middle">
								<td class="bc" align="left">
									&nbsp; &#8226; &nbsp;
									<a target="_blank" href="/top?g=checkers&v=gzcheckers">
										GZ Checkers Top 100
									</a>
									<br>
									&nbsp; &#8226; &nbsp;
									<a target="_blank" href="/rules?g=checkers&v=gzcheckers">
										GZ Checkers Rules
									</a>
									<br>
								</td>
								...
								<td class="bc" align="left">
									&nbsp; &#8226; &nbsp;
									<a target="_blank" href="/top?g=checkers&v=uscheckers">
										American Checkers Top 100
									</a>
									<br>
									&nbsp; &#8226; &nbsp;
									<a target="_blank" href="/rules?g=checkers&v=uscheckers">
								...
								<td class="bc" align="left">
									&nbsp; &#8226; &nbsp;
									<a target="_blank" href="/top?g=checkers&v=brdraughts">
										Brazilian Draughts Top 100
									</a>
									<br>
									&nbsp; &#8226; &nbsp;
									<a target="_blank" href="/rules?g=checkers&v=brdraughts">
								...
								<td class="bc" align="left">
									&nbsp; &#8226; &nbsp;
									<a target="_blank" href="/top?g=checkers&v=spdraughts">
										Spanish Draughts Top 100
									</a>
									<br>
									&nbsp; &#8226; &nbsp;
									<a target="_blank" href="/rules?g=checkers&v=spdraughts">
								...
								<td class="bc" align="left">
									&nbsp; &#8226; &nbsp;
									<a target="_blank" href="/top?g=checkers&v=rudraughts">
										Russian Draughts Top 100
									</a>
									<br>
									&nbsp; &#8226; &nbsp;
									<a target="_blank" href="/rules?g=checkers&v=rudraughts">
								...
								<td class="bc" align="left">
									&nbsp; &#8226; &nbsp;
									<a target="_blank" href="/top?g=checkers&v=itdraughts">
										Italian Draughts Top 100
									</a>
									<br>
									&nbsp; &#8226; &nbsp;
									<a target="_blank" href="/rules?g=checkers&v=itdraughts">
